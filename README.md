...
# Css.Odev-2 -------->Google Eski Ana Sayfasını Tasarlamak

Bu ödevde HTML'de öğrendiğimiz tüm konuları kapsayacak şekilde Google'ın eski sayfa yapısını CSS yapılarıyla birlikte tasarladık.

# Css.Odev-3 -------->Google Yeni Ana Sayfasını Tasarlamak

Bu ödevde HTML'de öğrendiğimiz tüm konuları kapsayacak şekilde Google'ın yeni sayfa yapısını CSS yapılarıyla birlikte tasarladık.
